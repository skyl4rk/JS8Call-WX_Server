...
message_period_3 = 45 # Number of minutes between transmissions
message_file_path_3 = 'test_message.txt' # Path and file name of message#
ENABLE_MESSAGE_BEACON_4 = False
message_period_4 = 33 # Number of minutes between transmissions
message_file_path_4 = 'heartbeat.txt' # Path and file name of message
ENABLE_MESSAGE_BEACON_5 = False
message_period_5 = 53 # Number of minutes between transmissions
